  ...
  axios({
    ...
    .then(function(response) {
      ...
      if (repo === 'contri-credit') {
        writeStream.write(
          `This template was generated by The After Hours\'s Contri-Credit project. If you have not set your package.json, please see our [README](https://github.com/the-after-hours/contri-credit#readme)\n`
        );
      }
